...
#textToSign = str(bytearray([0, 124, 213, 66, 221, 251, 203, 196, 218, 98, 62, 47, 173, 180, 24, 40, 5, 115, 10, 177, 169, 95, 211, 218, 196, 160, 222, 2, 93, 129, 247, 93, 212, 138, 181, 114, 101, 206, 8, 244, 209, 107, 70, 47, 8, 231, 2, 76, 0, 34, 3, 17, 74, 90, 216, 185, 151, 76, 249, 232, 130, 154, 223, 42, 105, 40, 164, 79, 164, 47, 1, 140, 202, 90, 116, 124, 127, 97, 230, 207, 241, 144, 60, 131, 252, 38, 124, 83, 149, 31, 228, 131, 86, 134, 39, 201, 124, 213, 66, 221, 251, 203, 196, 218, 98, 62, 47, 173, 180, 24, 40, 5, 115, 10, 177, 169, 95, 211, 218, 196, 160, 222, 2, 93, 129, 247, 93, 212, 138, 181, 114, 101, 206, 8, 244, 209, 107, 70, 47, 8, 231, 2, 76, 0]))
textToSign = str(bytearray([0, 124, 213, 66, 221, 251, 203, 196, 218, 98, 62, 47, 173, 180, 24, 40, 5, 115, 10, 177, 169, 95, 211, 218, 196, 160, 222, 2, 93, 129, 247, 93, 212, 138, 181, 114, 101, 206, 8, 244, 209, 107, 70, 47, 8, 231, 2, 76]))
print "length of text to sign is: " + str(len(textToSign))
...
try:
	...
	while offset != len(textToSign):
		...
		if (offset + len(chunk)) == len(textToSign):
			...
			p1 = 0x00
		apdu = bytes("e002".decode('hex')) + chr(p1) + chr(0x00) + chr(len(chunk)) + bytes(chunk)
                start = time.time()
